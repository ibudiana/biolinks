...
$status_member = cek_status_member($username);

if($status_member != 'active'){
    echo "<script>
            alert('Member belum aktif, silahkan aktifkan terlebih dahulu!');
            setTimeout(function(){
                window.location.href = '$domain/dashboard/admin-list.php';
            }, 100);
          </script>";
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if(isset($_POST['profile']) || isset($_POST['bio']) || isset($_FILES['image'])){
        ...
        if(!$save_profile){
            ...
            header("Location: $domain/dashboard/admin-edit.php?username=".$_SESSION['username']);
        }
    }
...
<div class="container">
    ...
    <main>
        ...
        <div class="admin">
            ...
            <div class="widget-admin">
                <div class="widget-admin-item">
                    <h2>Edit Member <?php echo $username; ?></h2>
                </div>
            </div>
        </div>
